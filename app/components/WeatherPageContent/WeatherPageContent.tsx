...
const WeatherPageContent = () => {
    ...
    return (
        <div className="w-auto h-screen overflow-y-scroll snap-y snap-mandatory">
            <div className="h-screen w-full flex items-center justify-center snap-center">
                <p className="text-center text-4xl font-black uppercase text-slate-600">
                    <span className="weather-text">Todays&nbsp;</span>
                    <span className="weather-text">weather&nbsp;</span>
                    <span className="weather-text">is&nbsp;</span><br /> 
            ...
            <div className="w-full flex justify-center snap-center">
                {isLoading && <p>Loading...</p>}
                {weeklyWeather && isFetched && !isLoading && weeklyWeather.length > 0 && (
                    <ul>
